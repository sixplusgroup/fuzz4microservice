...
public class ExtremeNegativeNumberValuesFuzzerTest {
    @Test
    public void testFuzz() {
        Field integerField = FuzzerTestAssistant.getMockIntegerField();
        Field fuzzedIntegerField = ExtremeNegativeNumberValuesFuzzer.getInstance().fuzz(integerField);
        ...
        Field fuzzedDecimalField = ExtremeNegativeNumberValuesFuzzer.getInstance().fuzz(decimalField);
